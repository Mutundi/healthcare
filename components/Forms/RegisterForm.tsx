          ...
          <section className="space-y-6">
            ...
            <div className="flex flex-col gap-6 xl:flex-row">
                <CustomFormField
                    ...
                    placeholder="PrimeHealth Coverage"
                />
            ...
            <div className="flex flex-col gap-6 xl:flex-row">
                <CustomFormField 
                    ...
                    placeholder="Paracetamol, Pollen"
                />
            ...
            {/* FAMILY MEDICATION & PAST MEDICATION*/}
            <div className="flex flex-col gap-6 xl:flex-row">
                <CustomFormField 
                    fieldType={FormFieldType.TEXTAREA}
                    control={form.control}
                    ...
                    placeholder="Father has hypertension, Mother had diabetes"
                />
                ...
                <CustomFormField 
                    ...
                    placeholder="Previous hospitalizations for pneumonia, ADHD diagnosis"
                />
            </div>
          </section>
